...
namespace Pulumi.Awstags
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Awstags.version.txt");
    ...
    internal sealed class AwstagsResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public AwstagsResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
